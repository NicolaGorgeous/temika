...
pathdir='/home/np451/data/oscillation_longtime/11.3.9/beads/BF/'
record_BF=5;  %%%%% seconds of record
%%%%illumination_BF=0.2;
illumination_BF=0.18; %for 40X
%illumination_BF=0.043;% for 20X
totT= 48*3600 %%% hours
